...
public class CartPage extends BasePage {
    ...
    public void backToIndex() {
        WebElement button = Waiter.waitForElement(driver, backToHomeButton);
        Objects.requireNonNull(Waiter.waitForElement(driver, backToHomeButton)).click();
    }

    public String getItemNameInCart() {
        return Objects.requireNonNull(Waiter.waitForElement(driver, elementName)).getText();
    }

    public String getItemQuantityInCart() {
        return Objects.requireNonNull(Waiter.waitForElement(driver, amountInCart)).getText();
    }

    public String getItemPriceInCart() {
        return Objects.requireNonNull(Waiter.waitForElement(driver, elementPriceInCart)).getText();
    }

    public String getTotalPriceOfCart(){
        return Objects.requireNonNull(Waiter.waitForElement(driver, totalPrice)).getText();
    }
}
